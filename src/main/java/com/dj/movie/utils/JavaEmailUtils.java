...
public class JavaEmailUtils {
	...
	// 发件人邮箱
	private static final String username = "1753000749@qq.com";
	// 发件人在邮箱服务器中的授权码
	private static final String password = "alayvcruzywicbjh";
	// 邮件的发送协议
	 ...
	 * @throws Exception
	 */
	public static MimeMessage createMessage(Session session, String to, String subject, String content)
			throws Exception {
