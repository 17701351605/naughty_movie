...
<form id="fm">
   ...
   <%-- <c:forEach items="${list}" var="a">
        ${a.baseName}<input type="radio" name="movieType" value="${a.id}" <c:if test="${a.id == movie.movieType}">checked</c:if>/>
    </c:forEach>--%>
    <br/>
    上线时间:<%-- <input type="text" name="topTime" value="${movie.topTimeShow}"/><br/> --%>
   ...
   <%-- 点赞数量:${movie.movieLike}<br/>--%>
  <%--  <input type="hidden" name="movieLike"value="${movie.movieLike}"/>--%>
    上下架:
